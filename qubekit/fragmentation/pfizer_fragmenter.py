...
class PfizerFragmentation(StageBase, PfizerFragmenter):
    type: Literal["PfizerFragmentation"] = "PfizerFragmentation"
    ...
    def _results_to_ligand(
        ...
        fragments = []
        for i, pfizer_fragment in enumerate(fragmentation_result.fragments):
            fragment = Fragment.from_smiles(pfizer_fragment.smiles, f"fragment_{i}")

            # attach the fragments as their own ligands
            fragment.bond_indices.append(pfizer_fragment.bond_indices)
    ...
    def start_message(self, **kwargs) -> str:
        ...
        return "Fragmenting molecule using the PfizerFragmenter"
